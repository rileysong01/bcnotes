...
var buttonClickHandler = function (event) {
  ...
  // make sure language variable has value
  if (language) {
...
var getFeaturedRepos = function (language) {
  ...
  // search for repos that are marked as featured and sorts based on number of help-wanted issues
...
var displayRepos = function (repos, searchTerm) {
  ...
  for (var i = 0; i < repos.length; i++) {
    ...
    // join corresponding login with repo seperated by /
