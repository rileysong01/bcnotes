...
// 2. const doesn't mean `constant value`, instead means `constant reference`
    // Unlike primitive data types (num, string, boolean), objects and arrays are passed by reference, rather than passed by value
...
//modifying 
item.price = "$1.99"; //change price property to "$1.99"
console.log(item);
